...
- Senha: edite `supabase/seed.sql` trocando `CHANGE_ME_BEFORE_RUNNING` por uma senha real antes de rodar — nunca commite o arquivo com a senha preenchida (altere após o primeiro login)
...
- **3 usuários de teste**: analista@agro.com / patrao@agro.com / campo@agro.com (senha, ver seção 1.3)
- Fazendas/talhões/defensivos de exemplo não fazem mais parte do seed — usar dado real da organização (ver `CONTRIBUTING.md` sobre processo de SQL versionado)
